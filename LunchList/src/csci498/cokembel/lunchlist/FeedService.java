...
public class FeedService extends IntentService {
	...
	public static final String EXTRA_MESSENGER = "csci498.cokembel.lunchlist.EXTRA_MESSENGER";
	...
	protected void onHandleIntent(Intent i) {
		...
		try {
			...
			Log.w("LunchList", "Exception sending results to activity through messenger", e);
		}
	}
